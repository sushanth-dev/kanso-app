...
import { resendConfigFromEnv, resendMailer, stubMailer } from './account/mailer.ts';
...
const mailer = process.env.MAILER_STUB === '1' ? stubMailer() : resendMailer(resendConfigFromEnv());
